...
export const SEO_CONFIG = {
	...
	"/": {
		...
		description:
			"Complete SaaS boilerplate with authentication, payments, admin panel, and more. Built with Next.js, Supabase, and polar.",
		keywords: "saas, boilerplate, nextjs, supabase, polar, starter",
		ogImage: "/og-home.png",
		ogType: "website",
	},
	...
	"/builder": {
		...
		description:
			"Configure your SaaS application and generate your repository setup. Customize Supabase, polar, and deployment settings.",
